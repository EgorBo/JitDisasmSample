...
REM quickly rebuild the app and copy Sample1.dll to the publish dir
dotnet build -c Release

MOVE /y bin\Release\net5.0\Sample1.dll bin\Release\net5.0\win-x64\publish\Sample1.dll

set "COMPlus_TieredCompilation=0"
set "COMPlus_JitDiffableDasm=1"
set "COMPlus_JitDisasm=SayHelloWorld"

bin\Release\net5.0\win-x64\publish\Sample1.exe
